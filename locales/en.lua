TranslationsEN = {
        ...
        auto_race_available = "Auto Race Available",
        press_e_to_join = "Press E to join",
        select_race_to_join = "Select Race to Join",
        press_esc_to_close = "Press ESC to close",
        automated = "Automated",
        no_races_available = "No races available",
        check_back_later = "Check back later for new races",
        use_mouse_to_select = "Use mouse to select race",
        double_click_to_join = "Double-click to join",
        cancel = "Cancel",
